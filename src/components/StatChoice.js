          ...
          <ContainerRestrictive>
            ...
            <ContainerDevideToHalf bgc={"var(--color-light)"}>
              <Paragraf align="justify">
                Sprawdz wyniki w swoim województwie, powiecie lub gminie!
                Wybierz z powyższego menu odpowiednią opcję (nazwę jednostki
                samorządu terytorialnego), a następnie naciśnij przycisk
                "szukaj".
              </Paragraf>
            </ContainerDevideToHalf>
          </ContainerRestrictive>
